function _onload(data) {
	...
	// 	main.insertAdjacentHTML("afterbegin", backButton);

	// 	const backButton = `
	//     <button onclick="window.history.back()"
	//         class="btn btn-sm btn-light position-absolute shadow"
	//         style="top: 60px; left: 10px; z-index: 10;">
...
function _fexp() {
	modal_.setMo({
		...
		body:
			"mengexport / mengirimkan data menuju tahapan selanjutnya akan beraksi seperti ini :<br>" +
			modal_.ol({
				cls: "",
				clsLi: "",
				data: [
