...
<body>
  ...
  <div class="body"></div>
        ...
        <a href='formpdf.php'><input name="button2" type="button" value="GAJI HARIAN"></a>
         <a href='signup.php'><input name="button3" type="button" value="SIGN UP"></a>
         <br><br><br><br><br><br><br><br>
        <form method='post' action='formuserinfo-proc.php'>
        ...
        <input type='text' name='bagian' placeholder="BAGIAN PEKERJAAN"/>
        <br>
         <p id="result"></p>
