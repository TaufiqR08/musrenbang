...
<body>
	...
	<table>
		<tr>
			<th>
				<table align="left">
					<form method="post" action="bgsok.php">
						<!-- <tr>
							<td>Option</td>
							<td><select style="width: 100%" id="option" onchange="action()">
								<option value="1">Semuah Pekerja</option>
								<option value="2">Satu Pekerja</option>	
							</select></td>
						</tr> -->
						<tr id="setnama">		
