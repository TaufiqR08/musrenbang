<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    function _tblMusrenbang($dt){
        ...
        $w2="20%;";$w5="50%;";$w07="7%;";$w26="26%;";
        $w18="18%;";$w6="60%;";$w09="9%;";$w08="8%";
        $w11="12%;";
        $html='
            <table cellspacing="0" cellpadding="0" border="0" style="text-align: center; width:100%;  font-size:10px;" border="1">
                <thead>
                    <tr>
                        ...
                        <th width="'.$w15.'">Desa</th>  
                        <th width="'.$w2.'">Usulan Permasalahan</th>
                        <th width="'.$w25.'">Data/Informasi Pendukung</th>
                        <th width="'.$w1.'">Pagu</th> 
                        <th width="'.$w1.'">Dinas</th>  
                        <th width="'.$w07.'">Keterangan</th>
                    </tr>
                </thead>
                <tbody>';
        // return print_r($dt);
